...
Esta actividad busca aplicar conceptos de organización en un \textit{espacio de trabajo} dentro del sistema operativo \textbf{GNU/Linux}, como la creación de \textit{directorios} y \textit{archivos}, además de aprender a moverse dentro de ellos de manera práctica. La tarea la llevé a cabo en \textbf{Debian 13 Trixie}, utilizando el entorno de escritorio \textbf{XFCE},  \textbf{xfce4-terminal} y el gestor de archivos \textbf{Thunar}.
