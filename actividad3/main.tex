...
\begin{itemize}
  ...
  \item \texttt{> fecha\_de\_colecta.tsv} $\rightarrow$ guarda el resultado en un nuevo archivo.
  \item \texttt{head -n 15 fecha\_de\_colecta.tsv | nl -ba} $\rightarrow$ muestra las primeras 15 líneas del archivo y las numera, incluyendo posibles líneas en blanco.
\end{itemize}
